            ...
            <div className="px-4 py-3">
              <div className="flex items-center gap-2 pb-2 border-b border-slate-700/30">
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                  message.media === 'video' ? 'bg-purple-500/20' : 
                  message.media === 'pdf' ? 'bg-red-500/20' : 'bg-green-500/20'
                }`}>
                  {message.media === 'video' && <Film className="w-4 h-4 text-purple-400" />}
                  {(message.media === 'document' || message.media === 'pdf') && <FileText className="w-4 h-4 text-red-400" />}
                </div>
